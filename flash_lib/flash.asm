...
; This file was generated Thu May  1 22:27:10 2014
;--------------------------------------------------------
...
_write_block:
	...
	BANKSEL	_write_block_i_1_4
	.line	43; flash.c	for(i = 0; i < 32; i++)
	CLRF	_write_block_i_1_4, B
_00106_DS_:
	...
	BANKSEL	_write_block_i_1_4
	.line	43; flash.c	for(i = 0; i < 32; i++)
	INCF	_write_block_i_1_4, F, B
	MOVLW	0x20
	BANKSEL	_write_block_i_1_4
	SUBWF	_write_block_i_1_4, W, B
	BNC	_00106_DS_
	bsf _EECON1, 7
	bcf _EECON1, 6
	bsf _EECON1, 2
